...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('administration', '0003_team_capitain'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Event date')),
                ...
                ('legs', models.IntegerField(default=6, verbose_name='Number of legs')),
                ('handicap', models.IntegerField(default=0)),
                ('away', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='away', to='administration.Team')),
                ('home', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='home', to='administration.Team')),
                ('season', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='schedule.Season')),
                ('week', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='schedule.MatchWeek')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('away', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='match_away', to='administration.Member')),
                ('home', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='match_home', to='administration.Member')),
                ('season', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='schedule.Season')),
                ('week', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='schedule.MatchWeek')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leg', models.IntegerField(verbose_name='leg number')),
                ('away', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='leagueframe_away', to='administration.Member')),
                ('home', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='leagueframe_home', to='administration.Member')),
            ],
